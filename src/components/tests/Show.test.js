...
const testShow = {
  ...
  name: "Castlevania",
  summary: "Follow Trevor Belmont on his journey as a vampire slayer.",
  seasons: [
    {
      id: 0,
      name: "Dracula's Anguish",
      episodes: [],
    },
    {
      id: 1,
      name: "Dracula's Scheme",
      episodes: [],
    },
    {
      id: 2,
      name: "Dracula's Conclusion",
      episodes: [],
    },
    {
      id: 3,
...
test("renders same number of options seasons are passed in", () => {
  ...
  expect(optionsSeasons).toHaveLength(4);
});
